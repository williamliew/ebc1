...
export default function SuggestNextBookPage() {
        ...
        return (
            <div className="min-h-screen bg-background text-foreground flex flex-col items-center justify-center p-6">
                ...
                <p className="text-muted text-center max-w-md">
                    Suggestions for the next book are currently closed. We open
                    suggestions for a short period each month—check back later
                    or ask the organisers when the next window opens.
                </p>
                <Link
                    href="/"
    ...
    const suggestionsLeft = MAX_SUGGESTIONS_PER_PERSON - userSuggestionCount;
    ...
    return (
        <div className="min-h-screen bg-background text-foreground flex flex-col pb-24">
            <header className="border-b border-border bg-surface px-4 py-4">
                ...
                <h1 className="text-xl font-semibold">Suggest next book</h1>
                <p className="text-sm text-muted mt-1">
                    You have used <strong>{userSuggestionCount}</strong> of{' '}
                    {MAX_SUGGESTIONS_PER_PERSON} suggestions this round. You
                    have <strong>{suggestionsLeft}</strong> suggestion
                                    ...
                                    <div className="flex items-center shrink-0">
                                        {item.suggestedByMe ? (
                                            <button
                                                type="button"
                                                disabled
                                                className="rounded-lg border border-border bg-surface px-3 py-2 text-sm font-medium text-muted cursor-default"
                                            >
                                                You suggested this book!
                                            </button>
                                        ) : canSuggestMore ? (
                                            <button
                                                type="button"
                                                onClick={() =>
                                                    setConfirmSuggest(item)
                                                }
                    ...
                    >
                        ...
                        <div className="p-4 overflow-y-auto flex-1">
                            ...
                            <p className="text-sm text-muted mb-4">
                                by {readMoreBook.author ?? 'Unknown author'}
                            </p>
                            {readMoreBook.blurb ? (
                                <div
                ...
                >
                    ...
                    >
                        <p className="text-sm mb-4">
                            ...
                            <strong>
                                {confirmSuggest.title ?? 'Unknown title'}
                            </strong>{' '}
                            by {confirmSuggest.author ?? 'Unknown author'}? This
                            action can&apos;t be changed.
                        </p>
                        <div className="flex gap-3">
                            ...
                            >
                                {confirmPending ? 'Adding…' : "Yes, I'm sure!"}
                            </button>
                        </div>
                    </div>
                </div>
                    ...
                    <div className="bg-surface rounded-xl shadow-xl max-w-lg w-full max-h-[90vh] overflow-hidden flex flex-col">
                        <div className="p-4 border-b border-border flex justify-between items-center shrink-0">
                            <h2 className="text-lg font-semibold">
                                {modalStep === 'search' && 'Search for a book'}
                                {modalStep === 'results' && 'Select a book'}
                                {modalStep === 'review' &&
                            ...
                            {modalStep === 'review' && selectedBook && (
                                <div className="space-y-4">
                                    ...
                                    {selectedBook.coverOptions &&
                                        selectedBook.coverOptions.length >
                                            1 && (
                                            <div>
